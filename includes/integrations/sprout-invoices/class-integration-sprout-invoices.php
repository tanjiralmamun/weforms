...
class WeForms_Integration_SI extends WeForms_Abstract_Integration
{
    ...
    protected function create_invoice($submission = array())
    {
        ...
        SI_Internal_Records::new_record( $submission['entry_note'], 'invoice_submission', $invoice_id, sprintf( __( 'Invoice Submitted: Form %s.', 'sprout-invoices' ), $submission['entry_id'] ), '', false );
